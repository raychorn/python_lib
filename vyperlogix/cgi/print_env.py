...
def print_env():
    ...
    if len(form) == 0:
        ...
        for var in keys:
            ...
            if isinstance(type(x), list):
                ...
                sys.stdout.write("(filename: %s, length: %d)" % (x.filename, len(x.value)))
            else:
                try:
    ...
    print('<table cellpadding="1" cellspacing="1">')
    print('<tr>')
    sys.stdout.write('<th align="left">User ID</th>')
    print('<td>', os.getuid(), '</td>')
    print('</tr>')
    print('<tr>')
    sys.stdout.write('<th align="left">Group ID</th>')
    print('<td>', os.getgid(), '</td>')
    print('</tr>')
    print('<tr>')
    sys.stdout.write('<th align="left">Effective User ID</th>')
    print('<td>', os.geteuid(), '</td>')
    print('</tr>')
    print('<tr>')
    sys.stdout.write('<th align="left">Effective Group ID</th>')
    ...
    print('<table cellpadding="1" cellspacing="1">')
    print('<tr>')
    sys.stdout.write('<th align="left">True Hostname</th>')
    print('<td>', socket.gethostbyaddr(socket.gethostbyname(socket.gethostname())), '</td>')
    print('<tr>')
    sys.stdout.write('<th align="left">Virtual Hostname</th>')
